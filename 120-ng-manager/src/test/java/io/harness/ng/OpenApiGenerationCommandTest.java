...
import static io.harness.ng.NextGenApplication.getOasConfig;
...
public class OpenApiGenerationCommandTest {
  ...
  public void setUp() throws MalformedURLException {
    ...
    final Bootstrap<NextGenConfiguration> bootstrap = new Bootstrap<>(new NextGenApplication());
    bootstrap.addCommand(
        new OpenApiGenerationCommand(getOasConfig(new NextGenConfiguration(), true), openApiOutputStream));
